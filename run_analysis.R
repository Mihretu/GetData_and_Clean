...
#write.table() using row.name=FALSE (do not cut and paste a dataset directly into the text box, as this may cause errors saving your submission).
write.table(test_and_train_data, file = "C:/Users/antoe76/Downloads/getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset/tidy_data.txt",row.names=FALSE)
...
write.table(final_average_value, file = "C:/Users/antoe76/Downloads/getdata_projectfiles_UCI HAR Dataset/UCI HAR Dataset/tidy_final_average_value.txt",row.names=FALSE)
